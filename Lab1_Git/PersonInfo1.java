public class PersonInfo1 {
    ...
    public static String firstName = "Meyssa";
    public static String lastName = "Smirani";
    public static int studentNo = 300030961;
    public static String description = "Like music
s";
